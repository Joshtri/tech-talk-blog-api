...
const postComment = async (req, res) => {
    try {
        const savedComment = await commentPublicService.postCommentService(req.body);
...
const countCommentById = async (req, res) => {
    try {
        const { id } = req.params;
        const totalComment = await commentPublicService.countCommentsByPostIdService(id);
